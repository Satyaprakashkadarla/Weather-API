...
function displayImageContent(data) {
  return `<img src="https://openweathermap.org/img/wn/${
    ...
    <h2 class="weather_temp">${Math.round(data.main.temp - 273)}°C</h2>
...
function rightSideContent(result) {
  return `<div class="content">
        ...
        <div class="content">
          ...
          <span class="value">${Math.round(result.main.temp - 273)}°C</span>
        </div>
        <div class="content">
...
function forecast(frContent) {
  ...
  <span>${joinDay}</span>
  <span class="day_temp">${Math.round(frContent.main.temp - 273)}°C</span>
</li>`;
}